...
import com.reynaldiyudhistira.bangsaldelimajambi.databinding.ActivityAddExpenseBinding;
...
public class AddExpenseActivity extends AppCompatActivity {
    ...
    private void createExpense() {
        ...
        boolean incomeRadioCheckedChecked=binding.incomeRadio.isChecked();
        if (incomeRadioCheckedChecked){
            type="Income";
        }else {
            type="Expense";
        }
