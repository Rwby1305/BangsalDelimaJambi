...
import com.reynaldiyudhistira.bangsaldelimajambi.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements OnItemsClick{
    ...
    private void setUpGraph() {
        ...
        if (income!=0){
            ...
            colorsList.add(getResources().getColor(R.color.lilac));
        }
        if (expense!=0){
            pieEntryList.add(new PieEntry(expense, "Expense"));
            colorsList.add(getResources().getColor(R.color.mulberry));
        }
